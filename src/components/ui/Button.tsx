...
export const Button = (props: ButtonProps & JSX.ButtonHTMLAttributes<HTMLButtonElement>) => {
    ...
    const variants = {
        primary: "bg-blue-700 hover:bg-blue-800 focus:ring-blue-300 disabled:bg-blue-400 dark:disabled:bg-blue-500 disabled:cursor-not-allowed",
        secondary: "bg-gray-700 hover:bg-gray-800 focus:ring-gray-300 disabled:bg-gray-400 dark:disabled:bg-gray-500 disabled:cursor-not-allowed",
        success: "bg-green-700 hover:bg-green-800 focus:ring-green-300 disabled:bg-green-400 dark:disabled:bg-green-500 disabled:cursor-not-allowed",
        ...
        warning: "bg-yellow-500 hover:bg-yellow-600 focus:ring-yellow-300 disabled:bg-yellow-400 dark:disabled:bg-yellow-500 disabled:cursor-not-allowed",
        ...
        outline: "border border-gray-300 text-gray-900 hover:bg-gray-100 focus:ring-gray-300 disabled:border-gray-400 disabled:text-gray-500 disabled:bg-gray-100 disabled:cursor-not-allowed",
      };
